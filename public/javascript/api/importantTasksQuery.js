...
document.addEventListener("DOMContentLoaded", () => {
      ...
      const callbackForCreateTaskInImportantList = (
        ...
        if (responseStatus == 201) {
          ...
          <button class="markTaskAsImportantButton">
            <svg viewBox="0 0 24 24" fill='#1175d3' width="21px" height="21px" xmlns="http://www.w3.org/2000/svg" class="markTaskAsImportantSvg">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
  ...
  /////////////////////////////////////////////////////////////////////////////////////
  function displayAllUserImportantTask() {
    const incompleteTaskDisplayContainer = document.getElementById(
      "incompleteTaskDisplayContainer"
    );
