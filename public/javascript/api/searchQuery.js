document.addEventListener("DOMContentLoaded", () => {
  ...
  searchInput.addEventListener("input", () => {
    const callbackForSearchUserTasks = (responseStatus, responseData) => {
      ...
      //Reset the dispklay from the previous search
      searchResultTaskDisplayContainer.innerHTML = ''
      if (responseStatus == 200) {
        responseData.forEach((task) => {
          ...
          `;
            searchResultTaskDisplayContainer.append(incompleteTask);
          ...
          `;
            searchResultTaskDisplayContainer.append(completedTask);
          }
        });
      } else {
